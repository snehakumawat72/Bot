...
const VapiAssistant = () => {
  ...
  if (window.vapiSDK) {
    ...
    const vapi = window.vapiSDK.run({
      ...
      assistant: '01ee8a41-3399-49e8-b51a-7e31ff74fa34',
      config: {
  ...
  return (
   <div className="vapi-wrapper">
      <h1 className="vapi-title">🎯 AceBOT: Full Stack Interview</h1>
      <p className="vapi-description">
        Get ready to ace your Full Stack interview with real-time voice interaction.
