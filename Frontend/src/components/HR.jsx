...
const VapiAssistant = () => {
  ...
  if (window.vapiSDK) {
    ...
    const vapi = window.vapiSDK.run({
      ...
      assistant: '982c199f-59f7-4325-9944-dee378d2c7a5',
      config: {
  ...
  return (
   <div className="vapi-wrapper">
      <h1 className="vapi-title">🎯 AceBOT: HR Interview</h1>
      <p className="vapi-description">
        Get ready to ace your HR interview with real-time voice interaction.
