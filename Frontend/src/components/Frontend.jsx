...
const VapiAssistant = () => {
  ...
  if (window.vapiSDK) {
    ...
    const vapi = window.vapiSDK.run({
      ...
      assistant: '723f2695-1afc-4ae3-9863-5a873c22e5b1',
      config: {
  ...
  return (
     <div className="vapi-wrapper">
      <h1 className="vapi-title">🎯 AceBOT: Frontend Interview</h1>
      <p className="vapi-description">
        Get ready to ace your Frontend interview with real-time voice interaction.
